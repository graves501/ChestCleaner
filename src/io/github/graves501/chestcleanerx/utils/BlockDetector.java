...
public class BlockDetector implements Listener {
	 ...
	 *
	 * @param player
	 *            The player you want to get the view vector from.
	 * @param range
	 *            The range you want to search for a non-air block.
	 * @return Returns the block the player is looking at, if there is no in
	 *         range it returns an air block.
	 */
